...
Ported from the original ``GlobalConsts`` helpers:

* ``[Genre]`` prefix/suffix extraction, with a blocklist of promo words.
* ``Artist - Title`` (and ``Artist — Title``) splitting, honouring a set of
