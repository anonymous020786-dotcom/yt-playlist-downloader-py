...
yt-dlp already embeds standard metadata and cover art via its post-processors.
This module adds the original app's *heuristic* layer on top: parse the video
title into artist / song title / genre, and set album + track number from the
playlist context. Uses mutagen so it works on mp3, m4a, flac, ogg and opus.
"""
